 ...
 */
import {audioResourceMap} from "../loader";
...
var Bonus = Class(Sprite, {
    Bonus: function (type, x, y) {
        this.img = audioResourceMap['tank.png'];
        this.type = type;
        this.x = x;
        this.y = y;
        this.width = 32;
    ...
    update: function () {
        ...
        if (Game.player.collidesWith(this)) {
            ...
            switch (this.type) {
                ...
                case 3:
                    Game.life++;
                    audioResourceMap['bonus-life.mp3'].play();
                    break;
                case 4:
                    Game.player.setInvincible(20000);
                    break;
                case 5:
                    audioResourceMap['boom.mp3'].play();
                    try {
                        for (const live of Game.enemyLiveArr) {
                            live.death();
                        }
                    }
                    catch (e) {
